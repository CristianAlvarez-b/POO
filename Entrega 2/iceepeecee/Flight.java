...
public class Flight
{
    private int[] from;             // Starting coordinates of the flight
    private int[] to;               // Ending coordinates of the flight
     ...
     */
    public void makePhoto(int theta){
        if(photograph != null){
            photograph.makeInvisible();
        }
     ...
     * @param theta The angle at which the photograph is taken.
     */
    public void makePhoto(double theta){
        if(photograph != null){
            photograph.makeInvisible();
        }
        makeInvisible();
