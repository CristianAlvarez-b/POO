...
public class DomainTest
{
    ...
    public void ShouldHungryAnt(){
        HungryAnt ant = new HungryAnt(colony, 5, 5);
        for(int i=0; i<50; i++){
            colony.ticTac();    
        }
    ...
    public void ShouldOpenFlower(){
        Flower flower = new Flower(colony, 28, 7);
        for(int i=0; i<4; i++){
            colony.ticTac();    
        }
    ...
    public void ShouldMoveGuardian(){
        Bee bee1 = new Bee( colony, 8, 20);
        Bee bee2 = new Bee( colony, 22,10);
        GuardianAnt guard = new GuardianAnt( colony, 0, 29);
        for(int i=0; i<20; i++){
            colony.ticTac();    
        }
    ...
    public void ShouldMoveBee(){
        Bee bee1 = new Bee( colony, 3, 3);
        Flower flower = new Flower(colony, 5, 5);
         for(int i=0; i<20; i++){
            colony.ticTac();    
        }
