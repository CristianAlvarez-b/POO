...
public class IceepeeceeContest
{
    ...
    //Using Iceepeecee
    public static Number solve(Number[][][] islands, Number[][][] flights) throws ICPC.IceepeeceeException {
    ...
    public static void simulate(Number[][][] islands, Number[][][]fligths) throws ICPC.IceepeeceeException {
