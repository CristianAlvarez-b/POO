...
public class Flight
{
    protected Number[] from;             // Starting coordinates of the flight
    protected Number[] to;               // Ending coordinates of the flight
    protected PolygonShape polygon;   // PolygonShape representing the flight's route
    protected Photograph photograph;  // Photograph taken along the flight's route
